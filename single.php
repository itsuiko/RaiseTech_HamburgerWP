    ...
    <div class="c-grid">
        ...
        <main class="l-main">
            ...
            <div class="p-mainvisual--singlepage">
                ...
                <h1 class="p-mainvisual__heading--singlepage">h1 チーズバーガー</h1>    
            </div>
            <div class="c-contents p-contents--singlepage">
                ...
                <div class="p-contents__img--singlepage">
                    <img class="p-contents__img" src="/images/cooked-foods-750073.jpg" alt="Hamburger">
                </div>
                <div class="p-card--singlepage">
                    <img class="p-card__img--singlepage" src="/images/cooked-foods2.jpg" alt="Hamburger">
                    <p class="p-card__text--singlepage">  テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストがテキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります </p>
                </div>
                <div class="p-card--singlepage2">
                    <img class="p-card__img--singlepage" src="/images/cooked-foods2.jpg" alt="Hamburger">
                    <p class="p-card__text--singlepage">  テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストがテキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります テキストが入ります </p>
                </div>
                <div class="p-contents__img2--singlepage">
                    <img class="p-contents__img2" src="/images/cooked-foods2.jpg" alt="Hamburger">
                </div>
                ...
                <table class="p-contents__table">
                    <tr class="p-contents__tr">
                        <th class="p-contents__th">テーブル</th>
                ...
                <button class="c-button p-contents__btn">ボタン</button>
                <p class="p-contents__text">boldboldboldboldboldboldbold</p>
            </div>
